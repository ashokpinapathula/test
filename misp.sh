...
key = \"${AUTH_KEY}\"" |sudo tee ${PATH_TO_MISP}/PyMISP/tests/keys.py
  ...
  ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -e $PATH_TO_MISP/PyMISP/.[fileobjects,neo,openioc,virustotal,pdfexport]
...
installCore () {
  ...
  if [[ ! -d ${PATH_TO_MISP} ]]; then
    ...
    ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 ordered-set python-dateutil six weakrefmethod
    debug "Install misp-stix"
    ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 ${PATH_TO_MISP}/app/files/scripts/misp-stix

    debug "Install PyMISP"
    ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 ${PATH_TO_MISP}/PyMISP
    ...
    # install pydeep
    false; while [[ $? -ne 0 ]]; do checkAptLock; ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 git+https://github.com/kbandla/pydeep.git; done

    # install lief
    ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 lief

    # install zmq needed by mispzmq
    ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 zmq redis

    # install python-magic
    ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 python-magic

    # install plyara
    ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 plyara
  else
    ...
    ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U setuptools pip lief zmq redis python-magic plyara

    ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U ${PATH_TO_MISP}/PyMISP
    false; while [[ $? -ne 0 ]]; do checkAptLock; ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U git+https://github.com/kbandla/pydeep.git; done
fi
}
...
mispmodules () {
  ...
  sudo chgrp $WWW_USER .
  sudo chmod og+w .
  $SUDO_WWW ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 pillow
  $SUDO_WWW ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -I -r REQUIREMENTS
  sudo chgrp staff .
  $SUDO_WWW ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -I .
  $SUDO_WWW ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 censys pyfaup
...
mispDashboard () {
  ...
  $SUDO_WWW ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 pyzmq
  cd /var/www
...
mail2misp () {
  ...
  ${SUDO_CMD} ./venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -r requirements.txt
...
viper () {
  ...
  $SUDO_CMD ./venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 pefile olefile jbxapi Crypto pypdns pypssl r2pipe pdftools virustotal-api SQLAlchemy PrettyTable python-magic scrapy lief
  $SUDO_CMD ./venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 .
  ...
  $SUDO_CMD /usr/local/src/viper/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -r requirements.txt
...
installCoreRHEL7 () {
  ...
  $SUDO_WWW $PATH_TO_MISP/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U pip setuptools
  ...
  # install zmq
  $SUDO_WWW $PATH_TO_MISP/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U zmq

  # install redis
  $SUDO_WWW $PATH_TO_MISP/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U redis

  # install magic, pydeep, lief
  $SUDO_WWW $PATH_TO_MISP/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U python-magic git+https://github.com/kbandla/pydeep.git plyara lief

  # install PyMISP
  cd $PATH_TO_MISP/PyMISP
  $SUDO_WWW $PATH_TO_MISP/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U .
...
$SUDO_WWW $PATH_TO_MISP/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U python-magic plyara
}
...
installCoreRHEL8 () {
  ...
  # install zmq, redis
  $SUDO_WWW $PATH_TO_MISP/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U zmq redis

  # install magic, pydeep
  $SUDO_WWW $PATH_TO_MISP/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U python-magic git+https://github.com/kbandla/pydeep.git plyara

  # install lief
  $SUDO_WWW $PATH_TO_MISP/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U lief || compileLiefRHEL8
...
mispmodulesRHEL () {
  ...
  cd misp-modules
  # pip install
  ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U -I -r REQUIREMENTS
  ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 -U .
  ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 pyfaup censys
  # some misp-modules dependencies for RHEL<8
...
installMISPonKali () {
  ...
  ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 .
  ...
  # install pydeep
  false; while [[ $? -ne 0 ]]; do ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 git+https://github.com/kbandla/pydeep.git; done
  ...
  # install zmq needed by mispzmq
  ${SUDO_WWW} ${PATH_TO_MISP}/venv/bin/pip install --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 --proxy=http://121.244.253.14:8080 zmq
